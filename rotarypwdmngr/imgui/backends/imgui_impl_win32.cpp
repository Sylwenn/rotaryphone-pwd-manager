...
static bool ImGui_ImplWin32_UpdateMouseCursor(ImGuiIO& io, ImGuiMouseCursor imgui_cursor)
{
	...
	else
	{
		...
		case ImGuiMouseCursor_Hand: win32_cursor = IDC_HAND;
			break;
		case ImGuiMouseCursor_Wait: win32_cursor = IDC_WAIT;
			break;
		case ImGuiMouseCursor_Progress: win32_cursor = IDC_APPSTARTING;
			break;
...
IMGUI_IMPL_API LRESULT im_gui_impl_win32_wnd_proc_handler(HWND hwnd, UINT msg, WPARAM w_param, LPARAM l_param)
{
	...
	if (ImGui::GetCurrentContext() == nullptr)
		return 0;
	return ImGui_ImplWin32_WndProcHandlerEx(hwnd, msg, w_param, l_param, ImGui::GetIO());
}
